...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://capsule-render.vercel.app/api?type=venom&color=0:A78BFA,50:22D3EE,100:4ADE80&height=220&text=youcisla&fontSize=70&fontColor=ffffff&animation=twinkling&desc=Systems%20Analyst%20%C2%B7%20Automation%20Builder%20%C2%B7%20AI-Native%20Developer&descSize=18&descAlignY=68"/>
  <source media="(prefers-color-scheme: light)" srcset="https://capsule-render.vercel.app/api?type=venom&color=0:A78BFA,50:22D3EE,100:4ADE80&height=220&text=youcisla&fontSize=70&fontColor=1B1F3A&animation=twinkling&desc=Systems%20Analyst%20%C2%B7%20Automation%20Builder%20%C2%B7%20AI-Native%20Developer&descSize=18&descAlignY=68"/>
  <img src="https://capsule-render.vercel.app/api?type=venom&color=0:A78BFA,50:22D3EE,100:4ADE80&height=220&text=youcisla&fontSize=70&fontColor=1B1F3A&animation=twinkling&desc=Systems%20Analyst%20%C2%B7%20Automation%20Builder%20%C2%B7%20AI-Native%20Developer&descSize=18&descAlignY=68" width="100%" alt="youcisla"/>
</picture>

<!-- THEME-AWARE TYPING: bright cyan on dark, deep teal on light -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=22D3EE&center=true&vCenter=true&width=740&lines=Automating+since+2020+%E2%80%94+multiplied+by+AI.;One+n8n+brain%2C+many+channels%2C+zero+hands.;Claude+Code+is+my+execution+layer.;AI+as+a+second+brain%2C+never+a+crutch."/>
  <source media="(prefers-color-scheme: light)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=0E7490&center=true&vCenter=true&width=740&lines=Automating+since+2020+%E2%80%94+multiplied+by+AI.;One+n8n+brain%2C+many+channels%2C+zero+hands.;Claude+Code+is+my+execution+layer.;AI+as+a+second+brain%2C+never+a+crutch."/>
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=0E7490&center=true&vCenter=true&width=740&lines=Automating+since+2020+%E2%80%94+multiplied+by+AI.;One+n8n+brain%2C+many+channels%2C+zero+hands.;Claude+Code+is+my+execution+layer.;AI+as+a+second+brain%2C+never+a+crutch." alt="Typing SVG"/>
</picture>
...
| System | Status | Stack |
|---|---|---|
| Production tooling @ INSEAD | ![live](https://img.shields.io/badge/●_LIVE-4ADE80?style=flat-square&labelColor=0D101E&color=0D101E&logoColor=4ADE80) | Next.js · TypeScript · Prisma · Supabase |
| Multi-channel content pipeline | ![autopilot](https://img.shields.io/badge/●_AUTOPILOT-22D3EE?style=flat-square&labelColor=0D101E&color=0D101E) | n8n · LLM agents · media APIs |
| Ticket management rebuild (client) | ![shipped](https://img.shields.io/badge/●_SHIPPED-A78BFA?style=flat-square&labelColor=0D101E&color=0D101E) | Full-stack · UX overhaul from scratch |
| Multi-agent side projects | ![iterating](https://img.shields.io/badge/●_ITERATING-FBBF24?style=flat-square&labelColor=0D101E&color=0D101E) | Claude Code · DeepSeek · MCP |
| Halal-compliant investing research | ![exploring](https://img.shields.io/badge/●_EXPLORING-FB7185?style=flat-square&labelColor=0D101E&color=0D101E) | Automation · finance data |
...
<!-- Activity graph (replaces the broken trophy widget) — fixed dark bg, theme-proof -->
